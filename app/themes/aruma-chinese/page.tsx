    ...
    <div className='w-full max-w-[380px] h-screen mx-auto relative bg-[#E6F9FA] overflow-x-hidden'>
      ...
      {activePage === 'menu' && (
        ...
        >
          ...
          <div id='gallery' className={`w-[80px] h-[80px] absolute left-[50px] top-[20%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsGaleriOpen(true); }}>
            <Image
              src={imgIcon.gallery}
              alt='Gallery'
              width={80}
