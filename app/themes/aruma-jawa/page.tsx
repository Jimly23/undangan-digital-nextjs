...
const warnaBg = "#e1b87e";
const warnaBorder = "#603310";
    ...
    <div className='w-full max-w-[380px] h-[100dvh] mx-auto relative bg-[#E6F9FA] overflow-x-hidden'>
      ...
      {activePage === 'menu' && (
        ...
        >
          ...
          <div id='gallery' className={`w-[90px] h-[90px] -rotate-1 absolute left-[50px] top-[20%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsGaleriOpen(true); }}>
            <Image
              src={imgIcon.gallery}
              alt='Gallery'
              width={90}
          ...
          <div id='gift' className={`w-[100px] h-[100px] absolute right-[7px] bottom-[20px] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse [animation-delay:200ms] cursor-pointer`}  onClick={() => { setOpenedFromPopup(false); setIsGiftOpen(true); }}>
            <Image src={imgIcon.gift} alt='Gift' width={120} height={120} />
          </div>
          ...
          <div id='about-us' className={`w-[110px] h-[110px] -rotate-4 absolute left-[160px] bottom-[43%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse-center [animation-delay:400ms] cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsAboutOpen(true); }}>
          ...
          <div id='dresscode' className={`w-[70px] h-[70px] absolute right-[75px] top-[30%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse [animation-delay:500ms] cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsDresscodeOpen(true); }}>
            <Image src={imgIcon.dresscode} alt='Dresscode' width={120} height={120} />
          </div>
          <div id='rsvp' className={`w-[80px] h-[80px] absolute right-[35px] bottom-[35%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse-center [animation-delay:150ms] cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsRsvpOpen(true); }}>
