    ...
    <div className='w-full max-w-[380px] h-[100dvh] mx-auto relative bg-[#E6F9FA] overflow-hidden'>
      ...
      {activePage === 'menu' && (
        ...
        >
          ...
          <div id='about-us' className={`w-[100px] h-[100px] absolute left-[180px] bottom-[57%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse-center [animation-delay:400ms] cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsAboutOpen(true); }}>
            <Image src={imgIcon.about} alt='About Us' width={150} height={150} />
          </div>

          <div id='date-venue' className={`w-[80px] h-[80px] absolute right-[80px] top-[6%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse [animation-delay:300ms] cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsDateOpen(true); }}>
          ...
          <div id='rsvp' className={`w-[90px] h-[90px] absolute right-[15px] bottom-[42%] flex items-center justify-center ${!isLightOn ? 'filter drop-shadow-[0_0_10px_rgba(51,213,208,1)]' : ''} animate-custom-pulse-center [animation-delay:150ms] cursor-pointer`} onClick={() => { setOpenedFromPopup(false); setIsRsvpOpen(true); }}>
