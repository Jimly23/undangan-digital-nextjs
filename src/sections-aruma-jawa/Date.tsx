    ...
    <Template isOpen={isOpen} onClose={onClose} title="Date & Venue">
      <div className="w-full bg-white rounded-3xl border-2 border-[#e1b87e] p-6 flex flex-col items-center justify-center relative overflow-hidden shadow-[0_0_15px_rgba(0,194,203,0.1)]">
        ...
        <div className="text-center z-10 w-full">
          ...
          <hr className="border-t border-[#e1b87e]/30 my-4 mx-auto w-[85%]" />
        ...
        <div className="grid grid-cols-4 gap-2 w-full z-10 px-1">
          <div className="bg-gradient-to-b from-[#EBFDFF] to-white border border-[#e1b87e]/40 rounded-xl p-2 flex flex-col items-center justify-center shadow-sm relative">
            <div className="absolute inset-0.5 border border-dashed border-[#e1b87e]/30 rounded-lg pointer-events-none" />
      ...
      <div className="w-full flex flex-col gap-4 items-center mt-2">
        <div className="w-full bg-white rounded-3xl border-2 border-[#e1b87e] p-3 relative shadow-[0_0_15px_rgba(0,194,203,0.1)]">
          <div className="absolute inset-1.5 border border-dashed border-[#e1b87e]/60 rounded-[18px] pointer-events-none" />
          ...
          <div className="mt-4 mb-2 bg-gradient-to-b from-[#EBFDFF] to-white border border-[#e1b87e]/40 rounded-2xl p-4 text-center relative mx-1">
            <div className="absolute inset-0.5 border border-dashed border-[#e1b87e]/30 rounded-xl pointer-events-none" />
        ...
        <div className="w-full flex flex-col items-center gap-4 mt-1">
          ...
          <div className="w-full bg-white rounded-2xl border border-[#e1b87e]/50 overflow-hidden shadow-sm">
            <div className="w-full h-11 border-b border-[#e1b87e]/40 flex items-center justify-center bg-gradient-to-b from-white to-[#F0FEFF]">
          ...
          <a
            ...
            className="w-full h-11 bg-[#9BF2F6] hover:bg-[#e1b87e] text-[#1A4345] hover:text-white font-bold text-sm tracking-wide rounded-full border-2 border-[#e1b87e] shadow-[0_3px_10px_rgba(0,194,203,0.15)] flex items-center justify-center transition active:scale-98"
          >
            Buka di Google Maps
          </a>
        </div>
