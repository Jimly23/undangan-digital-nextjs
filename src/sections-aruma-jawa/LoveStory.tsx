...
export default function LoveStory({ isOpen, onClose }: LoveStoryPopupProps) {
  ...
  return (
    <Template isOpen={isOpen} onClose={onClose} title="Love Story">
      <div className="w-full bg-white rounded-3xl border-2 border-[#e1b87e] p-6 flex flex-col relative overflow-hidden shadow-[0_4px_15px_rgba(0,194,203,0.08)] mb-5">
        ...
        <div className="z-10">
          ...
          <hr className="border-t border-[#e1b87e]/30 my-3 w-full" />
        </div>
